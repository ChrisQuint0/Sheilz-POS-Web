...
* **Manager**: Access to Dashboard, Inventory, Sales, Analytics, and POS Settings. Can manage Cashiers. Cannot typically view Audit Logs.
* **Cashier**: Access limited to the POS interface (front-end, not this admin panel) and potentially viewing their own sales history. Cannot access POS Settings, Team, or Analytics.
