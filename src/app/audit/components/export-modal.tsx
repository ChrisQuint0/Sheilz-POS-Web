...
interface ExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  onExport: (startDate: string, endDate: string, preset: ExportDatePreset) => void;
  isLoading?: boolean;
}
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Select a date range to export your audit records.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          <div className="flex flex-col gap-2">
            ...
            <Select
              value={preset}
              onValueChange={(val) => setPreset(val as ExportDatePreset)}
            >
