    ...
    >
      <div className="flex justify-between items-start mb-3">
        <div>
          ...
          <div className="font-semibold text-sm">{transaction.orderId}</div>
        </div>
        <Badge
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-medium">{transaction.orderType}</span>
        </div>
        ...
        <div className="flex justify-between">
          ...
          <span
            ...
            title={transaction.items.map((i) => i.name).join(", ")}
          >
