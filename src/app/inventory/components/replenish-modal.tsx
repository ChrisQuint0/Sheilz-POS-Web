          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <DialogDescription className="text-[13px] text-gray-400">
                {item.name} · Current: {item.currentStock.toLocaleString()}{" "}
                {item.unit}
              </DialogDescription>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1">
            {steps.map((s, i) => (
              <React.Fragment key={s.num}>
                ...
                >
                  <span
                    className={`w-6 h-6 rounded-full text-[10px] flex items-center justify-center font-bold border-2 transition-all ${
                      step === s.num
                ...
                {i < steps.length - 1 && (
                  <div
                    className={`flex-1 h-0.5 rounded-full mx-1 ${step > s.num ? "bg-emerald-400" : "bg-gray-200"}`}
                  />
                )}
              </React.Fragment>
            ))}
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="e.g. ABC Beverage Supplies"
                  value={supplier}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={(e) =>
                      setQuantityDelivered(Number(e.target.value))
                    }
                ...
                <div className="p-4 space-y-2.5 text-[13px]">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-emerald-600">
                      +{quantityDelivered.toLocaleString()} {item.unit}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-[#3a2b27] text-base">
                      {newStock.toLocaleString()} {item.unit}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Expense</span>
                    <span className="font-semibold text-[#C2456A]">
                      ₱
